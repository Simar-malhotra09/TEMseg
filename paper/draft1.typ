...
#show: ieee.with(
  ...
  abstract: [
    Measuring and analyzing particle size and shape distributions of nanoparticles obtained through Transmission Electron Microscopy (TEM) is an important thing. This involves some form of manual/semi-automated/automated instance segmentation of the particles and then performing analysis on them. We present a tool which aims to provide semi and fully automated methds of performing instance segmentation using modern deep learning models and providing common analyzes all emdeded in a modern desktop application which allows space for human-machine collaboration 
  ],
)
